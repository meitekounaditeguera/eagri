                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/galerie/galeriephoto_liste/'.$this->uri->segment(4))?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                    <form class="form-horizontal" action="<?php echo site_url('backend/galerie/galeriephoto_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Nom du produit *</label>
                                                <input class="form-control" required="required" type="text" id="titre_actu" name="titre_actu" placeholder="Titre">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Conditionnement *</label>
                                                <input class="form-control" required="required" type="text" id="conditionnement" name="conditionnement" placeholder="conditionnement">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Prix </label>
                                                <input class="form-control" required="required" type="text" id="prix" name="prix" placeholder="Titre">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label>Détails du produit en texte *</label>
                                                <textarea id="js-ckeditor"  cols="30" name="detail" id="detail"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="image">image (JPG, PDF, GIF, DOC) *</label>
                                            <div class="col-xs-12">
                                                <input id="userfile"  name="userfile" type="file">
                                            </div>
                                        </div>

                                        <input type="hidden" name="idevent" id="idevent" class="form-control" value="<?php echo $this->uri->segment(4); ?>">
