                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/formation/formation_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/formation/formation_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Type</label>
                                                <select  class="form-control" name="type">
                                                    <option value="continentaux" >Texte continentaux</option>
                                                    <option value="nationaux" >Texte nationaux</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Libélle *</label>
                                                <input class="form-control" required="required" type="text" id="titre" name="titre" placeholder="Titre du document">
                                            </div>
