                                ...
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal" action="<?php echo site_url('dashboard/Profile/profile_modif') ?>" method="post" id="add_admin"  enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" id="libelle" name="libelle" placeholder="Libellé" value="<?php echo $get->libelle;?>" required="required">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="description">Description (brève présentation) *</label>
                                            <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                            <label class="col-xs-12" for="libelle">Téléphone *</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" id="libelle" name="telephone" placeholder="Téléphone" value="<?php echo $get->telephone;?>" required="required">
