...
<a href="<?php echo site_url('backend/evenement/evenement_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/evenement/evenement_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Type actualité</label>
                                                <select  class="form-control" name="type_actu">
                                                    ...
                                                    <option <?php if($get->type=='ASFM') echo "selected='selected'";?>>ASFM</option>
                                                    <option <?php if($get->type=='JOURNEE-SIMIJ') echo "selected='selected'";?>>JOURNEE-SIMIJ</option>
                                        ...
                                        <input type="hidden" name="idevenement" id="idevenement" class="form-control" value="<?php echo $get->id; ?>">
