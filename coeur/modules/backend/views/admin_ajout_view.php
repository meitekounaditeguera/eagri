            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo base_url() ?>assets/admin/img/photos/photo3@2x.jpg');">
                    <div class="push-50-t push-15">
                        ...
                        <h2 class="h5 text-white-op animated zoomIn">Ajout d'un administrateur</h2>
                    </div>
                </div>
                <!-- END Page Header -->
                            ...
                            <div class="block">
                                <?php
                                    ...
                                    if($add == 'success'){
                                      ...
                                      <strong>Administrateur ajouté avec succès</strong>
                                       </div>';

                                    }
                                ?>
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal" action="<?php echo site_url('backend/admin_ajout') ?>" method="post" id="add_admin">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control" id="niveau" required="required" name="niveau" size="1">
                                                    ...
                                                    <option value="2">Admin standart</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="libelle">Nom & Prénom(s)</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" id="libelle" name="libelle" placeholder="Libellé">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="pwd">Mot de passe</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="password" id="pwd" name="pwd" placeholder="Password..">
                                                 <?php echo form_error('pwd','<span class="error">','</span>'); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="password" id="confirmpwd" name="confirmpwd" placeholder="Confirm Password">
                                                <?php echo form_error('confirmpwd','<span class="error">','</span>'); ?>
