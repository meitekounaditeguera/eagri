...
<a href="<?php echo site_url('backend/lien/lien_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/lien/lien_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Libelle *</label>
                                                <input class="form-control" required="required" type="text" id="libelle" name="libelle" value="<?php echo $get->libelle;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Lien URL *</label>
                                                <input class="form-control" required="required" type="text" id="lien" name="lien" value="<?php echo $get->lien;?>">
                                            </div>
                                        ...
                                        <input type="hidden" name="idlien" id="idlien" class="form-control" value="<?php echo $get->id; ?>">
