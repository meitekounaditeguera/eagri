                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/banniere/banniere_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/banniere/banniere_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Theme</label>
                                                <input class="form-control" required="required" type="text" id="titre_actu" name="titre_actu" placeholder="">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Texte</label>
                                                <input class="form-control" required="required" type="text" id="texte_actu" name="texte_actu" placeholder="">
                                            </div>
