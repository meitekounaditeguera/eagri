...
<a href="<?php echo site_url('backend/banniere/banniere_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/banniere/banniere_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Theme</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Texte</label>
                                                <input class="form-control" required="required" type="text" id="texte_actu" name="texte_actu" value="<?php echo $get->texte_actu;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                         <img src="<?php echo base_url() ?>uploads/banniere/<?php echo $get->fichier;?>" style="max-width: 220px" alt="<?php echo $get->fichier;?>">
                                        ...
                                        <input type="hidden" name="idbanniere" id="idbanniere" class="form-control" value="<?php echo $get->id; ?>">
