...
<a href="<?php echo site_url('backend/agenda/agenda_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/agenda/agenda_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Titre *</label>
                                                <input class="form-control" required="required" type="text" id="titre" name="titre" value="<?php echo $get->titre; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Date début </label>
                                                <input class="form-control" required="required" type="date" id="debut" name="debut" value="<?php echo $get->debut; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Date fin </label>
                                                <input   value="<?php echo $get->fin; ?>" class="form-control" required="required" type="date" id="fin" name="fin">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label>Texte *</label>
                                                <textarea id="js-ckeditor"  cols="30" name="texte" id="texte"><?php echo $get->texte; ?></textarea>
                                            </div>
                                        ...
                                        <input type="hidden" name="idagenda" id="idagenda" class="form-control" value="<?php echo $get->id; ?>">
