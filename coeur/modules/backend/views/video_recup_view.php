...
<a href="<?php echo site_url('backend/video/video_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/video/video_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Code Youtube *</label>
                                                <input class="form-control" required="required" type="text" id="code" name="code" value="<?php echo $get->code;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Date </label>
                                                <input class="form-control" required="required" type="date" id="dates" name="dates" value="<?php echo $get->dates;?>">
                                            </div>
                                        ...
                                        <input type="hidden" name="idvideo" id="idvideo" class="form-control" value="<?php echo $get->id; ?>">
