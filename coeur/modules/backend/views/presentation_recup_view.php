...
<a href="<?php echo site_url('backend/presentation/presentation_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/presentation/presentation_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         <img src="<?php echo base_url() ?>uploads/fichier/<?php echo $get->fichier;?>" style="max-width: 220px" alt="<?php echo $get->fichier;?>">
                                        ...
                                        <input type="hidden" name="idpresentation" id="idpresentation" class="form-control" value="<?php echo $get->id; ?>">
