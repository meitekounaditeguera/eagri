                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/agenda/agenda_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/agenda/agenda_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Titre *</label>
                                                <input class="form-control" required="required" type="text" id="titre" name="titre" placeholder="Titre">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Date début </label>
                                                <input class="form-control" required="required" type="date" id="debut" name="debut">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Date fin </label>
                                                <input class="form-control" required="required" type="date" id="fin" name="fin">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label>Texte *</label>
                                                <textarea id="js-ckeditor"  cols="30" name="texte" id="texte"></textarea>
                                            </div>
