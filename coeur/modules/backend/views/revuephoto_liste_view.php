            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo base_url() ?>assets/admin/img/photos/photo3@2x.jpg');">
                    <div class="push-50-t push-15">
                        ...
                        <h2 class="h5 text-white-op animated zoomIn" style="color: yellow;">                        REVUE DE PRESSE (IMAGES)
...
<strong>Album :</strong> <?php echo $get->titre_actu;?>  <a href="<?php echo site_url('backend/revue/revuephoto_ajout/'.$this->uri->segment(4))?>" class="btn btn-sm btn-primary" >Ajouter photo</a>
...
<br><br>
         <table class="table table-striped table-bordered table-vcenter js-dataTable-full-pagination">
                <thead>
                   ...
                   <?php if ($liste_revuephoto != null): ?>
                        <?php $i = 1; ?>
                        <?php foreach ($liste_revuephoto as $row): ?>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url() ?>uploads/revue/<?php echo $row->fichier;?>" style="max-width: 220px" alt="<?php echo $row->fichier;?>">

                                    </td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                             <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editer" onClick="javascript:location.href='<?php echo site_url('backend/revue/revuephoto_recup/'.$this->uri->segment(4)."/".$row->id) ; ?>'"><i class="fa fa-pencil"></i></button>



                                        <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" onClick="javascript:if(window.confirm('Voulez-vous supprimer cet admin ?')){location.href='<?php echo site_url('backend/revue/revuephoto_supp/'.$row->id) ; ?>'; return true;} else {return false;}" title="Supprimer"><i class="fa fa-times"></i></button>
