                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/evenement/evenement_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                    <form class="form-horizontal" action="<?php echo site_url('backend/evenement/evenement_ajout/') ?>" method="post" enctype="multipart/form-data">
