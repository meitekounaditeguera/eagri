...
<a href="<?php echo site_url('backend/actualite/actualite_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/actualite/actualite_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         <img src="<?php echo base_url() ?>uploads/actu/<?php echo $get->fichier;?>" style="max-width: 220px" alt="<?php echo $get->fichier;?>">
                                        ...
                                        <input type="hidden" name="idactualite" id="idactualite" class="form-control" value="<?php echo $get->id; ?>">
