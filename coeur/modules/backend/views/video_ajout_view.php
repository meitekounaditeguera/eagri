                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/video/video_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/video/video_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Code Youtube *</label>
                                                <input class="form-control" required="required" type="text" id="code" name="code" placeholder="Code Youtube">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Date </label>
                                                <input class="form-control" required="required" type="date" id="dates" name="dates">
                                            </div>
