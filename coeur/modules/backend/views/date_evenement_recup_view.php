...
<a href="<?php echo site_url('backend/evenement/date_evenement_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/evenement/date_evenement_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Lien pour des details *</label>
                                                <input class="form-control" required="required" type="text" id="lien_actu" name="lien_actu" value="<?php echo $get->lien_actu;?>">
                                            </div>
                                        ...
                                        <input type="hidden" name="iddate_evenement" id="iddate_evenement" class="form-control" value="<?php echo $get->id; ?>">
