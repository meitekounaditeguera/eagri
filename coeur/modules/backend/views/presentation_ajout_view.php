                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/presentation/presentation_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                    <form class="form-horizontal" action="<?php echo site_url('backend/presentation/presentation_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Type actualité</label>
                                                <select  class="form-control" name="type_actu">
                                                    <option>CONGRES</option>
                                                    <option>JOURNEES</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Titre *</label>
                                                <input class="form-control" required="required" type="text" id="titre_actu" name="titre_actu" placeholder="Titre de l'article">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Date </label>
                                                <input class="form-control" required="required" type="date" id="date_actu" name="date_actu">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label>Texte *</label>
                                                <textarea id="js-ckeditor"  cols="30" name="texte_actu" id="texte_actu"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="image">Fichier (JPG, PDF, GIF, DOC) *</label>
                                            <div class="col-xs-12">
