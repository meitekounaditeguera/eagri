...
<a href="<?php echo site_url('backend/galerie/galeriephoto_liste/'.$this->uri->segment(4))?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/galerie/galeriephoto_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Conditionnement *</label>
                                                <input class="form-control" required="required" type="text" id="conditionnement" name="conditionnement"  value="<?php echo $get->conditionnement;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Prix </label>
                                                <input class="form-control" required="required" type="text" id="prix" name="prix"  value="<?php echo $get->prix;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Détails du produit en texte *</label>
                                                <textarea id="js-ckeditor"  cols="30" name="detail" id="detail"><?php echo $get->detail;?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                         <img src="<?php echo base_url() ?>uploads/galerie/<?php echo $get->fichier;?>" style="max-width: 220px" alt="<?php echo $get->fichier;?>">
                                        ...
                                        <input type="hidden" name="idphoto" id="idphoto" class="form-control" value="<?php echo $get->id; ?>">
