...
<a href="<?php echo site_url('backend/contact/contact_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                 ...
                                 <form class="form-horizontal" action="<?php echo site_url('backend/contact/contact_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Téléphone *</label>
                                                <input class="form-control" required="required" type="text" id="tel" name="tel" value="<?php echo $get->tel;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Fax *</label>
                                                <input class="form-control" required="required" type="text" id="fax" name="fax"  value="<?php echo $get->fax;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Boite postale *</label>
                                                <input class="form-control" required="required" type="text" id="bp" name="bp" value="<?php echo $get->bp;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">E-mail *</label>
                                                <input class="form-control" required="required" type="email" id="email" name="email" value="<?php echo $get->email;?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Situation géographique *</label>
                                                <input class="form-control" required="required" type="text" id="adresse" name="adresse" value="<?php echo $get->adresse;?>">
                                            </div>
                                        ...
                                        <input type="hidden" name="idcontact" id="idcontact" class="form-control" value="<?php echo $get->id; ?>">
