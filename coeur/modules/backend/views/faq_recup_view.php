...
<a href="<?php echo site_url('backend/faq/faq_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/faq/faq_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="idfaq" id="idfaq" class="form-control" value="<?php echo $get->id; ?>">
