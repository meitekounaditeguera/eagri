...
<a href="<?php echo site_url('backend/partenaire/partenaire_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/partenaire/partenaire_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Site web *</label>
                                        ...
                                        <div class="form-group">
                                         <img src="<?php echo base_url() ?>uploads/fichier/<?php echo $get->fichier;?>" style="max-width: 220px" alt="<?php echo $get->fichier;?>">
                                            <label class="col-xs-12" for="image">Logo</label>
                                            <div class="col-xs-12">
                                                <input id="userfile" name="userfile" type="file">
                                            </div>
                                        </div>

                                        <input type="hidden" name="idpartenaire" id="idpartenaire" class="form-control" value="<?php echo $get->id; ?>">
