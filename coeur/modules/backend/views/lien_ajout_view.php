                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/lien/lien_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>
                                    ...
                                    <form class="form-horizontal" action="<?php echo site_url('backend/lien/lien_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Libelle *</label>
                                                <input class="form-control" required="required" type="text" id="libelle" name="libelle" placeholder="Titre">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Lien URL *</label>
                                                <input class="form-control" required="required" type="text" id="lien" name="lien" placeholder="Code Youtube">
                                            </div>
