...
<a href="<?php echo site_url('backend/formation/formation_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                 <form class="form-horizontal" action="<?php echo site_url('backend/formation/formation_modif/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Type</label>
                                                <select  class="form-control" name="type">
                                                    <option value="continentaux"  <?php if($get->type=="continentaux") echo "selected='selected'";?> >Texte continentaux</option>
                                                    <option value="nationaux" <?php if($get->type=="nationaux") echo "selected='selected'";?>>Texte nationaux</option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Libelle *</label>
                                        ...
                                        <div class="form-group">
                                         <?php echo $get->fichier;?>
                                            <label class="col-xs-12" for="image">Fichier pdf</label>
                                            <div class="col-xs-12">
                                        ...
                                        <input type="hidden" name="idformation" id="idformation" class="form-control" value="<?php echo $get->id; ?>">
