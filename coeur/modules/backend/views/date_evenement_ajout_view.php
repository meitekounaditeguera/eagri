                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/evenement/date_evenement_liste/')?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                    <form class="form-horizontal" action="<?php echo site_url('backend/evenement/date_evenement_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="english">Titre *</label>
                                                <input class="form-control" required="required" type="text" id="titre_actu" name="titre_actu" placeholder="Titre de levement">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                            <label class="english">Lien pour des details *</label>
                                                <input class="form-control" required="required" type="text" id="lien_actu" name="lien_actu" >
                                            </div>
