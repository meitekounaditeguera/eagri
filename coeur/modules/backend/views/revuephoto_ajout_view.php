                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block-content block-content-narrow">
                                 ...
                                 <a href="<?php echo site_url('backend/revue/revuephoto_liste/'.$this->uri->segment(4))?>" class="btn btn-sm btn-primary" >Retour</a><br><br>

                                    <form class="form-horizontal" action="<?php echo site_url('backend/revue/revuephoto_ajout/') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12" for="image">Fichier (JPG, GIF ) *</label>
                                            <div class="col-xs-12">
                                        ...
                                        <input type="hidden" name="idrevue" id="idrevue" class="form-control" value="<?php echo $this->uri->segment(4); ?>">
