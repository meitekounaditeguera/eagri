                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                          ...
                          <a class="nav-link" href="<?php  echo base_url()?>administration/agriculteurs/ajouter_agriculteur"> <button type="button" class="btn btn-primary">  Ajouter un nouvel agriculteur </button> </a>
        ...
        $i=1;
         foreach($abc as $ligne) { ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $ligne->boite_postale?></td>
                        <td><?php echo $ligne->nombre_annee?></td>
                        <td><?php echo $ligne->biographie?></td>
                        ...
                        <td align="center">
                                ...
                                <div class="d-flex">
                                 ...
                                 <a title="Modifier" href="<?php echo base_url()?>administration/agriculteurs/agriculteur_recup/<?php echo $ligne->idagri?>" class="btn btn-primary shadow btn-xs sharp mr-1"> <i class="bi bi-pencil-square"> </i> </a>&nbsp;  


                             
                                 <a  title="Detail" href="<?php echo base_url()?>administration/agriculteurs/agriculteur_detail/<?php echo $ligne->idagri?>" class="btn btn-warning shadow btn-xs sharp">
